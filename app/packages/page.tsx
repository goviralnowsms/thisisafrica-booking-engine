...
export default function PackagesPage() {
  ...
  const handleSearch = async () => {
    if (!selectedCountry && !selectedDestination) {
      alert('Please select a country or destination to search for Pre-designed packages')
      return
    }
    ...
    try {
      ...
      params.set('productType', 'Pre-designed packages')
      ...
      {!searchPerformed && (
        <section className="py-12 bg-amber-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Ready for Your All-Inclusive Adventure?</h2>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Select your preferred destination above to discover our comprehensive travel packages. 
              Everything is taken care of so you can focus on creating unforgettable memories.
            </p>
