	  ...
	  <!--left sidebar start here-->
		...
		<!--Trip Search start here-->
          <div class="find-your-trip">
			...
			<?php /*?>
            <form method="post" name="groupsearch" id="groupsearch" action="<?php echo get_site_url();?>/group-tours-list">
             ...
             <div class="origin-section"> <span>Origin</span>
					<?php
					//Get Locations here
						$GetAllLocations = '<?xml version="1.0"?>
						<!DOCTYPE Request SYSTEM "hostConnect_5_05_000.dtd">
							<Request>
							 <GetLocationsRequest>
							  <AgentID>'.AGENTID.'</AgentID>
						...
						$ResLocations = WPXMLREQUEST($GetAllLocations);
						//echo"<pre>";print_r($ResLocations);die;
					?>

                <select id="origin" name="origin">

					<?php
					if($ResLocations['GetLocationsReply']['Locations']['Location'])
					{
						$Locations = $ResLocations['GetLocationsReply']['Locations']['Location'];
              ...
              <div  ><!--<a href="javascript:;" onclick="groupsubmit()">Search Now</a>-->
			  <input class="search search-submit" type="submit" name="groupsearch" value="Search Now"></div>
            </form><?php */?>
          </div>
