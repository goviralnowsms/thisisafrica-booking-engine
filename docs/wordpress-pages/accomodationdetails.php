<?php
/**
 * Template Name: accomodationdetails
 * The template for displaying Accommodation details
 *
                ...
                <div class="panel-body">
                    <div class="tab-content">
						...
						<!--<h2><?php //echo $SupplierName;?></h2>
							...
							<?php
								if($Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote']['NoteCategory']=="PI1")
								{
										echo $NoteTextPII = $Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote']['NoteText'];
								}
								else if($Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote'][1]['NoteCategory']=="PI1")
								{
									echo $NoteTextPII =  $Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote'][1]['NoteText'];
								}
								else if($Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote'][2]['NoteCategory']=="PI1")
								{
									echo $NoteTextPII =  $Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote'][2]['NoteText'];
								}
								else if($Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote'][3]['NoteCategory']=="PI1")
								{
									echo $NoteTextPII =  $Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote'][3]['NoteText'];
								}
								else if($Response['OptionInfoReply']['Option']['OptionNotes']['OptionNote'][4]['NoteCategory']=="PI1")
								{
