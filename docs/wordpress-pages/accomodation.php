    ...
    <div class="about-us"> 
	  ...
	  <!--left sidebar start here-->
		...
		<!--Trip Search start here-->
          ...
          <div class="side-add"><a href="#"><img src="<?php echo THEME_IMG_PATH; ?>/add.jpg"></a></div>
                ...
                <div class="panel-heading">
                    ...
                    <span class="pull-right">
                        ...
                        <ul class="nav panel-tabs">
                            <li class="active"><a href="#tab1" data-toggle="tab">Accommodation </a></li>
                            <li><a href="#tab2" data-toggle="tab">Search by Map</a></li>
                            </ul>
                    </span>
                </div>
